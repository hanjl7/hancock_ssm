	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
									...
									<c:forEach items="${userList}" var="user">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?id=${user.id}" class="btn bg-olive btn-xs">添加用户角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
			...
			<strong>Copyright &copy; 2014-2017 <a
				href="https://github.com/Giraffehjl/hancock_ssm">HANCOCK  </a>.
