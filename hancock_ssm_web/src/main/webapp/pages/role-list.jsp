	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
									...
									<c:forEach items="${roleList}" var="role">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/role/findUserByIdAndAllPermission.do?roleId=${role.id}" class="btn bg-olive btn-xs">添加角色权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
			...
			<strong>Copyright &copy; 2014-2017 <a
				href="https://github.com/Giraffehjl/hancock_ssm/hancock_ssm">HANCOCK-后台管理</a>.
