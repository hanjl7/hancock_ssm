...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/sysLog/findAll.do?page=1&size=5">日志管理</a></li>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2017 <a
                href="http://www.hjl.cn">HANCOCK-后台管理</a>.
...
<script>
    function changePageSize() {
        ...
        //向服务器发送请求，改变没页显示条数
        location.href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${pageNum}&size=" + pageSize;
    }
